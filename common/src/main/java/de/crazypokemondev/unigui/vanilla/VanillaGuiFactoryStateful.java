...
public class VanillaGuiFactoryStateful extends VanillaGuiFactory {
    private final BiFunction<ServerPlayer, GuiState, Gui> supplier;
     ...
     */
    public VanillaGuiFactoryStateful(String id, BiFunction<ServerPlayer, GuiState, Gui> supplier) {
        super(id);
        this.supplier = supplier;
    }

    @Override
    public @NotNull Gui createGui(ServerPlayer player, @Nullable GuiState state) {
